...
from utils import encode_segmap, decode_segmap, n_classes, valid_classes
...
class CityScapesDataLoader(Cityscapes):
...
class Model(pl.LightningModule):
    def __init__(self):
        ...
        self.train_class = CityScapesDataLoader("data/blur_data/", split='train', mode='fine', target_type="semantic", transforms=transform)

        self.val_class = CityScapesDataLoader("data/blur_data/", split='val', mode='fine', target_type="semantic", transforms=transform)
...
if __name__ == '__main__':
    ...
    trainer = pl.Trainer(resume_from_checkpoint='./basic_checkpoints/blur.ckpt', max_epochs=20, auto_lr_find=False, auto_scale_batch_size=False, callbacks=[checkpoint_callback])
